...
<div class="container">
    <div class="row" style="padding-top:80px;">
        <ol class="breadcrumb">
            ...
            <li><a href="http://dravp.cpu-bioinfor.org/browse/ProteinData.php">Browse</a></li>
            <li class="active">Antiviral protein</li>
        </ol>
    </div>
    <div class="row mt40" style="padding-top: 20px">
        ...
        <table class="table table-bordered">
            ...
            $sq="select * from antiviral_protein  order by DRAVPR_ID asc";
            ...
            $sqld="select * from antiviral_protein order by DRAVPR_ID asc limit $start,$pagesize";
            ...
            for($i=0;$i<count($row);$i++){
                ...
                echo ' <tr>
                <td><a href="protein_information.php?id='.$row['DRAVPR_ID'].'" >'.$row['DRAVPR_ID'].'</a></td>
                <td>'.$row['Name'].'</td>
                <td>'.$row['Source'].'</td>
                <td ><a target="_blank" href="https://www.uniprot.org/uniprotkb/'.$row['Uniprot_ID'].'">'.$row['Uniprot_ID'].'</a></td>
                <td>'.$swiss_temp.'</td>
            </tr>';
            }
            ?>
...
<div class="container mt-5">
    ...
    <div class="text-right mb-5">
        ...
        echo ' <a href="ProteinData.php?page=1" class="btn btn-default">First</a> ';
        ...
        if($pagecount>$showpages){
            ...
            for($i=$start;$i<=$end;$i++){
                if($i==$page){
                    echo ' <a href="ProteinData.php?page='.$i.'" class="btn btn-primary">'.$i.'</a> ';
                }else{
                    echo ' <a href="ProteinData.php?page='.$i.'" class="btn btn-default" >'.$i.'</a> ';
                }
            }
        }else{
            for($i=$start;$i<=$end;$i++) {
        ...
        echo ' <a href="ProteinData.php?page='.$pagecount.'" class="btn btn-default">Last</a> ';
