        ...
        <!--general information-->
         ...
         <div style="padding: 12px;background-color: #f7f7f7;border: 1px solid #ddd;border-radius: 12px;">
            ...
            <div style="padding: 12px;background-color: #f7f7f7;border: 1px solid #ddd;border-radius: 12px;">
                ...
                <p>
                    <span style="color: #4478b1;font-size:18px;">Predicted Structure Download</span>&nbsp; <a href="http://dravp.cpu-bioinfor.org/Structure/download.php?filename=./predicted_structure/<?php echo $row['Predicted_structure_ID']?>.pdb"><?php echo $row['Predicted_structure_ID']?></a>
                </p>
                <p>
                    <br/>
